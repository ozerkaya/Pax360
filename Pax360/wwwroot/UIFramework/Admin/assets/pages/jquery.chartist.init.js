...
//Simple line chart
 Chartist.Line('#simple-line-chart', {
...
var data = times(52).map(() => getSecureRandom()).reduce(function(data, rnd, index) {
  data.labels.push(index + 1);
  data.series.forEach(function(series) {
    series.push(getSecureRandom() * 100)
  });
  return data;
}, {
  labels: [],
...
Chartist.Line('#scatter-diagram', data, options, responsiveOptions);
...
Chartist.Line('#line-chart-tooltips', {
  labels: ['1', '2', '3', '4', '5', '6'],
  series: [
    {
...
Chartist.Bar('#bi-polar-bar', data, options);
...
Chartist.Bar('#overlapping-bars', data, options, responsiveOptions);
...
//Distributed series
 ...
 Chartist.Bar('#distributed-series', {
...
//Label placement
 ...
 Chartist.Bar('#label-placement-chart', {
...
var responsiveOptions = [
 ...
 Chartist.Pie('#pie-chart', data, options, responsiveOptions);



//Gauge chart

 Chartist.Pie('#gauge-chart', {
  series: [20, 10, 30, 40]
}, {
  donut: true,
  donutWidth: 60,
