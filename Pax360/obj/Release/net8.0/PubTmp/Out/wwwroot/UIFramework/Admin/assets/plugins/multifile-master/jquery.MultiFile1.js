    ...
    $.fn.MultiFile = function (options) {
        ...
        this
            ...
            .each(function () {
                ...
                o.maxsize = o.maxsize > 0
                    ? o.maxsize
                    : MultiFile.E.data('maxsize') || 0;
                ...
                o.maxfile = o.maxfile > 0
                    ? o.maxfile
                    : MultiFile.E.data('maxfile') || 0;
                            ...
                            var v = file.name.replace(/^C:\\fakepath\\/gi, ''),
                                ...
                                p = function (z) {
                                    return z
                                        ...
                                        .replace('$ext', String(v.split('.').pop() || ''))
                                        .replace('$file', v.split(/[\/\\]/).pop() || '')
                ...
                MultiFile.addToList = function (slave, slave_count, files) {
                        ...
                        var v = String(file.name || '').replace(/[&<>'"]/g, function (c) { return '&#' + c.charCodeAt() + ';'; }),
                            ...
                            label = $(
                                (                                   
                                    ...
                                    '<select class="form-control" id="ApplicationType#' + file.name + '" name="ApplicationType"><option value="">Select</option>' +
                                    '<option value="System Files">System Files</option>' +
                                    '<option value="Firmware">Firmware</option>' +
                                    '<option value="Banking application">Banking application</option>' +
                                    '<option value="Non-finance Application">Non-finance Application</option>' +
                                    '</select>' +
                                    '</div>' +
                                    '</div>' +
                                    ...
                                    '<select class="form-control" id="ApplicationSubType#' + file.name + '" name="ApplicationSubType"><option value="">Select</option>' +
                                    '<option value="OS">OS</option>' +
                                    '<option value="Manager">Manager</option>' +
                                    '<option value="PUK">PUK</option>' +
                                    '<option value="Kernel Libraries">Kernel Libraries</option>' +
                                    ...
                                    '<option value="NonFinance Apps">NonFinance Apps</option>' +
                                    '</select>' +
                                    '</div>' +
                                    '</div>' +
                                    ...
                                    '<input autocomplete="off" class="form-control" id="ApplicationVersion#' + file.name + '" name="ApplicationVersion" type="text" value="">' +
                                    '</div>' +
                                    '</div>' +
                                    ...
                                    //'<input autocomplete="off" class="form-control" id="ApplicationName#' + file.name + '" name="ApplicationName" type="text" value="">' +
                                    '<input autocomplete="off" class="form-control" id="ApplicationName#' + file.name + '" name="ApplicationName" type="text" value="' + file.name + '" disabled style="background:#ffffff;">' +
                                    '</div>' +
                                    '</div>' +
                                    ...
                                    .replace(/\$(file|name)/gi, v.split(/[\/\\]/).pop() || v)
                                    .replace(/\$(ext|extension|type)/gi, (v.split('.').pop() || ''))
                    ...
                    var
                        r = $('<div class="MultiFile-label" style="margin-top: 5px;margin-left: -11px;"></div>'),
